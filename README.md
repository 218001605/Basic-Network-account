A Mobile operator awards points to customers based on their monthly consumption of airtimes. A customer gain ½ point for each R5 airtime bought. Some examples of point calculation are provided below.
